...
This is my Decentralised Stable Coin created while completing lesson 12 of the PAtrick Collins Solidity course.
...
Massive Shoutout to Patrick Collins and the Cyfrin team for putting together this course.
Had a great time working through the challenges of this lesson and excited to learn more!

- I struggled to get the Invariants Tests to not Revert, ran into a problem where the Minting of collateral was breaking health factor on a number of the calls.

- The Liquidation tests were especcially tricky to figure out so ended up having to refer to the repo for alot of them.